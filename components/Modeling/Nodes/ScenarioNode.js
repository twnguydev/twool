            ...
            <div className="space-y-3">
              {(data.scenarios || []).map((scenario, index) => (
                ...
                >
                  ...
                  <div className="text-xs font-mono mt-2 text-gray-700 bg-white p-2 rounded-sm border border-gray-100">
              ...
              {(data.scenarios || []).length === 0 && (
                <div className="text-center py-4 text-gray-500 text-sm flex flex-col items-center">
                  ...
                  <button className="mt-2 text-xs text-blue-600 hover:text-blue-800 underline focus:outline-hidden">
                    Ajouter un scénario
                  </button>
                </div>
              )}
            ...
            <div>
              {data.simulationResults ? (
                ...
                <div className="text-center py-8 text-gray-500 text-sm flex flex-col items-center">
                  ...
                  <button className="mt-3 px-3 py-1 text-xs text-white bg-blue-500 hover:bg-blue-600 rounded-md focus:outline-hidden flex items-center">
