          ...
          <div className="px-6 py-8 md:flex md:items-center md:justify-between">
            <div className="max-w-xl md:max-w-2xl">
              ...
              <div className="mt-4 flex space-x-4">
                <Link href="/modeling">
                  <div className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-xs text-sm font-medium text-indigo-700 bg-white hover:bg-indigo-50 cursor-pointer">
                    Créer un Processus
                  </div>
                </Link>
                <a href="#" className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-xs text-sm font-medium text-white bg-indigo-800 bg-opacity-30 hover:bg-opacity-40">
                  Voir le Tutoriel
                </a>
              </div>
            </div>
